...
const ProductivityStats = () => {
  ...
  return (
    <section className="section min-h-screen bg-gradient-to-br from-black via-blue-900 to-black py-20">
      <div className="max-w-6xl mx-auto px-8">
        ...
        <div className="mb-16">
          <div className={`bg-gradient-to-r ${stats[currentStat].color} p-1 rounded-2xl`}>
            <div className="bg-black rounded-xl p-12 text-center">
              ...
              <div className="text-lg text-cyan-400 mb-4 tracking-wider">
                {stats[currentStat].category}
              </div>
              
              <div className="text-6xl md:text-8xl font-bold text-yellow-400 mb-6 animate-pulse">
              ...
              <a 
                ...
                className="text-cyan-400 hover:text-yellow-400 transition-colors underline text-lg"
              >
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {stats.map((stat, index) => (
            <div 
              key={index}
              className={`border-2 border-yellow-400 rounded-lg p-6 bg-black bg-opacity-70 transition-all duration-500 hover:scale-105 cursor-pointer ${
            ...
            >
              ...
              <div className="text-sm text-cyan-400 mb-2 tracking-wider">
                {stat.category}
              </div>
